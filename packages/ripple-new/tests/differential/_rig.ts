 ...
 * ripple-new AND @tsrx/react, mounts each into a hidden container, drives
 ...
 *
 * Mechanics:
 *   - The ripple-new side just imports the .tsrx file directly — the
 *     existing Vitest plugin compiles it via packages/ripple-new/compiler.
 ...
 *   - ripple-new's `<!--…-->` slot markers (start/end Comment nodes used as
 ...
 *   - Whitespace-only text nodes between elements (ripple-new preserves
...
/**
 * Sort attribute names within each opening tag alphabetically. ripple-new
 ...
 * export name to mount on the ripple-new side (and the same name will be
